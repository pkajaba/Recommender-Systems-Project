...
ActiveRecord::Schema.define(version: 20161211105119) do
  ...
  create_table "predicted_ratings", force: :cascade do |t|
    t.integer  "predicted_rating"
    t.integer  "joke_id"
    t.integer  "user_id"
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["joke_id"], name: "index_predicted_ratings_on_joke_id", using: :btree
    t.index ["user_id"], name: "index_predicted_ratings_on_user_id", using: :btree
  end
  ...
  add_foreign_key "predicted_ratings", "jokes"
  add_foreign_key "predicted_ratings", "users"
